                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-red-200/70 text-sm leading-relaxed">
                        ...
                        been approved at this time. We appreciate your interest
                        in the Iloilo Business Club. You are welcome to review
                        our membership requirements and submit a new
                        application.
                      </p>
                    </div>
                    <Link
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <Tooltip>
                  <TooltipTrigger className="w-full cursor-help">
                    <div className="flex w-full items-center gap-4 rounded-xl border border-white/5 bg-[#1f2937]/50 p-4 text-left transition-colors hover:border-white/10 hover:bg-[#1f2937]/80">
                  ...
                  <TooltipContent>
                    <p>{formatDateTime(result.interview.interviewDate)}</p>
                  </TooltipContent>
                </Tooltip>
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>{result.interview.interviewVenue}</p>
                  </TooltipContent>
                </Tooltip>
              </div>
