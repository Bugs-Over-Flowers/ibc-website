          ...
          {benefits.map((benefit) => {
            ...
            return (
              <motion.div key={benefit.id} variants={fadeInUp}>
                <Card className="group hover:-translate-y-1 relative h-full overflow-hidden border-0 bg-white/70 shadow-xl ring-1 ring-white/50 backdrop-blur-xl transition-all duration-300 hover:shadow-2xl">
