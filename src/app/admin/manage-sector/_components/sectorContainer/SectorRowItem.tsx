...
export default function SectorRowItem({
  ...
  return (
    <li>
      <button
        className="group flex w-full items-center gap-4 rounded-md px-4 py-3.5 transition-colors hover:bg-muted/40 focus:outline-none focus:ring-2 focus:ring-ring"
      ...
      >
        ...
        <div className="min-w-0 flex-1 text-left">
          <p className="truncate text-left font-semibold text-foreground text-lg md:text-xl">
            {sectorName}
          </p>
        </div>
