create type "public"."WebsiteContentSection" as enum ('vision_mission', 'goals', 'company_thrusts', 'board_of_trustees', 'secretariat', 'landing_page_benefits');

create type "public"."WebsiteContentTextType" as enum ('Paragraph', 'Title', 'Subtitle');
...
CREATE UNIQUE INDEX "WebsiteContent_pkey" ON public."WebsiteContent" USING btree (id);
...
alter table "public"."WebsiteContent" add constraint "WebsiteContent_pkey" PRIMARY KEY using index "WebsiteContent_pkey";

alter table "public"."WebsiteContent" add constraint "WebsiteContent_cardPlacement_nonnegative" CHECK ((("cardPlacement" IS NULL) OR ("cardPlacement" >= 1))) not valid;

alter table "public"."WebsiteContent" validate constraint "WebsiteContent_cardPlacement_nonnegative";

alter table "public"."WebsiteContent" add constraint "WebsiteContent_content_present" CHECK ((("textValue" IS NOT NULL) OR (icon IS NOT NULL) OR ("imageUrl" IS NOT NULL))) not valid;

alter table "public"."WebsiteContent" validate constraint "WebsiteContent_content_present";
...
grant delete on table "public"."WebsiteContent" to "anon";

grant insert on table "public"."WebsiteContent" to "anon";

grant references on table "public"."WebsiteContent" to "anon";

grant select on table "public"."WebsiteContent" to "anon";

grant trigger on table "public"."WebsiteContent" to "anon";

grant truncate on table "public"."WebsiteContent" to "anon";

grant update on table "public"."WebsiteContent" to "anon";

grant delete on table "public"."WebsiteContent" to "authenticated";

grant insert on table "public"."WebsiteContent" to "authenticated";

grant references on table "public"."WebsiteContent" to "authenticated";

grant select on table "public"."WebsiteContent" to "authenticated";

grant trigger on table "public"."WebsiteContent" to "authenticated";

grant truncate on table "public"."WebsiteContent" to "authenticated";

grant update on table "public"."WebsiteContent" to "authenticated";

grant delete on table "public"."WebsiteContent" to "service_role";

grant insert on table "public"."WebsiteContent" to "service_role";

grant references on table "public"."WebsiteContent" to "service_role";

grant select on table "public"."WebsiteContent" to "service_role";

grant trigger on table "public"."WebsiteContent" to "service_role";

grant truncate on table "public"."WebsiteContent" to "service_role";

grant update on table "public"."WebsiteContent" to "service_role";
