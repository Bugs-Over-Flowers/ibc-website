-- =============================================================================
-- Fix import_event_registrations to generate participantIdentifier
-- =============================================================================
-- The Participant table requires participantIdentifier (NOT NULL, no default)
-- but the import function was not generating one, causing every import row
